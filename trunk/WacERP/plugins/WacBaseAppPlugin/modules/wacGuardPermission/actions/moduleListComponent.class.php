...
class moduleListComponent extends WacModuleListComponent
{
    ...
    public function setupJqGridCols(){
        ...
        $listCols[] = $jqGridDataHelper->getCol(array("name"=>"name", "label"=>$i18n->__("Coding"), "index"=>"name", "editable"=>"true", "width"=>"250", "align"=>"left"));
        $listCols[] = $jqGridDataHelper->getCol(array("name"=>"description", "label"=>$i18n->__("Name"), "index"=>"description", "editable"=>"true", "width"=>"250"));
