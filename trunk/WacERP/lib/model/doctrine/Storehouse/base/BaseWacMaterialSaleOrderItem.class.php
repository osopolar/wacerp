...
Doctrine_Manager::getInstance()->bindComponent('WacMaterialSaleOrderItem', 'wac_db_connection1');

/**
 * BaseWacMaterialSaleOrderItem
 * 
 ...
 * @method WacMaterialSaleOrderItem setQty()           Sets the current record's "qty" value
 * @method WacMaterialSaleOrderItem setQtyUnitCode()   Sets the current record's "qty_unit_code" value
 * @method WacMaterialSaleOrderItem setUnitPrice()     Sets the current record's "unit_price" value
 * @method WacMaterialSaleOrderItem setPrInt1()        Sets the current record's "pr_int1" value
 * @method WacMaterialSaleOrderItem setPrInt2()        Sets the current record's "pr_int2" value
 * @method WacMaterialSaleOrderItem setPrStr1()        Sets the current record's "pr_str1" value
 * @method WacMaterialSaleOrderItem setPrStr2()        Sets the current record's "pr_str2" value
 * @method WacMaterialSaleOrderItem setPriority()      Sets the current record's "priority" value
 ...
 */
abstract class BaseWacMaterialSaleOrderItem extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('wac_material_sale_order_item');
