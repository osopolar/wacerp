...
class baseInlineTableAComponent extends WacComponent
{
    ...
    public function setupJqGridCols(){
        ...
        $listCols[] = $jqGridDataHelper->getCol(array("name"=>"is_avail", "label"=>$i18n->__("Is avail"), "index"=>"description", "editable"=>"true", "edittype"=>"checkbox", "formatter"=>"WacEntity.jqGridFormatter.availFormatter", "unformat"=>"WacEntity.jqGridFormatter.availUnformatter", "editoptions"=>"{value:\"1:0\", defaultValue:\"1\"}", "width"=>"60"));
        return $listCols;
    }
