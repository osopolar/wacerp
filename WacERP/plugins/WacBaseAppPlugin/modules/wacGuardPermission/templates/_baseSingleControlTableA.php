    ...
    jQuery("#<?php echo WacModuleHelper::getListId($invokeParams['moduleName']); ?>").jqGrid({
        ...
        gridComplete: function(){
            ...
            for(var i=0;i < ids.length;i++){
                var cl = ids[i];
                be = "<input style='height:28px;width:28px;' type='button' value='编' onclick=\"jQuery('#<?php echo WacModuleHelper::getListId($invokeParams['moduleName']);?>').jqGrid('editRow','"+cl+"', true, null, <?php echo $invokeParams['moduleName']; ?>CallbackSave, '" + editUrl + "');\" />";
                se = "<input style='height:28px;width:28px;' type='button' value='存' onclick=\"jQuery('#<?php echo WacModuleHelper::getListId($invokeParams['moduleName']);?>').jqGrid('saveRow', '"+cl+"', <?php echo $invokeParams['moduleName']; ?>CallbackSave, '" + editUrl + "', {}, null);\" />";
                ce = "<input style='height:28px;width:28px;' type='button' value='消' onclick=\"jQuery('#<?php echo WacModuleHelper::getListId($invokeParams['moduleName']);?>').jqGrid('restoreRow', '"+cl+"');\" />";
                de = "<input style='height:28px;width:28px;' type='button' value='删' onclick=\"jQuery('#<?php echo WacModuleHelper::getListId($invokeParams['moduleName']);?>').jqGrid('delGridRow', '"+cl+"', {url:'" + delUrl + "', top: 200, left:500});\" />";
