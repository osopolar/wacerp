...
Doctrine_Manager::getInstance()->bindComponent('WacTemplate', 'wac_db_connection1');
 ...
 */
abstract class BaseWacTemplate extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('wac_template');
