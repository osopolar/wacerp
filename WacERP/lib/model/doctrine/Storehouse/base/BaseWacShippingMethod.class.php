...
Doctrine_Manager::getInstance()->bindComponent('WacShippingMethod', 'wac_db_connection1');

/**
 * BaseWacShippingMethod
 * 
 ...
 */
abstract class BaseWacShippingMethod extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('wac_shipping_method');
