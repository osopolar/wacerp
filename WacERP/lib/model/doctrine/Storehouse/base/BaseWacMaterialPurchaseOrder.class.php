...
Doctrine_Manager::getInstance()->bindComponent('WacMaterialPurchaseOrder', 'wac_db_connection1');

/**
 * BaseWacMaterialPurchaseOrder
 * 
 ...
 */
abstract class BaseWacMaterialPurchaseOrder extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('wac_material_purchase_order');
